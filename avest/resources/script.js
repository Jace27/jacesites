...
function printResult () {
	...
	forPrint += "Сылка на расчет: <br><input type=\"text\" value=\""+decodeURI(window.location.origin + window.location.pathname + "?name="+document.getElementById("name").value+"&surname="+document.getElementById("surname").value+"&daybirth="+document.getElementById("dayBirth").value+"&monthbirth="+document.getElementById("monthBirth").value+"&yearbirth="+document.getElementById("yearBirth").value)+"\" id=\"link_for_copy\" style=\"min-width: 75%; font-size: 0.75em\"><span class=\"iscopied\" id=\"is-copied-label\">Скопировано!</span>";
